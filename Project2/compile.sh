...
machine=$(uname)
alias macCompile='g++-8 -DNUMT=$threads -DNUMTRIALS=$trials -DLAST=$last -o proj2 main.cpp -lm -fopenmp'
alias linuxCompile='g++ -DNUMT=$threads -DNUMTRIALS=$trials -DLAST=$last -o proj2 main.cpp -lm -fopenmp'
last=0
