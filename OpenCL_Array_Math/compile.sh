...
rm output.csv
echo " , 1024, 4096, 16384, 65536, 262144, 1048576, 4194304, 8388608, 16777216, 33554432" >> output.csv
...
do
    ...
    do
        ...
        for globalSize in 1024 4096 16384 65536 262144 1048576 4194304 8388608 16777216 33554432 67108864
        do
